...
export const StatusBadge: React.FC<{ status: CommentStatus }> = ({ status }) => {
  const styles = {
    [CommentStatus.Approved]: "bg-emerald-50 text-emerald-700 border-emerald-200/50",
    [CommentStatus.Hold]: "bg-amber-50 text-amber-700 border-amber-200/50",
    [CommentStatus.Spam]: "bg-orange-50 text-orange-700 border-orange-200/50",
    [CommentStatus.Trash]: "bg-rose-50 text-rose-700 border-rose-200/50",
  };

  const labels = {
    [CommentStatus.Approved]: "Approved",
    [CommentStatus.Hold]: "Pending",
